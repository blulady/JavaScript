...
function checkWinConditions() {
    ...
    //This condition checks checks for tie. If none of the above condition register 
    //and 9 squares are selected, the code excutees.
    else if (selectedSquares.length >= 9) {
        //this function plays the tie game sound.
        audio('./media/tie2.mp3');
        //this function sets a .3 second times before the restgame is called.
...
function disableClick() {
    ...
    //this makes our body cliable again after 1 second
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        //This line indicates where the end of a lines x axis is
        y2 = coordY2,
        //This variable stores temporary x axis data we updat in our animation loop.
        x = x1,
        //this variable stores temporary y axis data we updat in our animation loop.
        y = y1;
    ...
    function animateLineDrawing () {
        ...
        c.beginPath();
        //this method movees us to a starting point for our line.
        c.moveTo(x1, y1);
    ...
    function animateLineDrawing() {
        //This variable creates the loop for when the game ends it restarts
        const animationLoop = requestAnimationFrame(animateLineDrawing);
        //thismethod clears content from the last loop iteration.
        c.clearRect(0, 0, 608, 608);
        //this method starts a new path
        c.beginPath();
...
//this function resets the game in a gie or a win
function resetGame() {
